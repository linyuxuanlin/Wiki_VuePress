...
Jupyter Notebooks 是一个很强大的工具，它允许我们在一个文档环境内编写、运行代码、查看输出、将数据可视化并查看结果……总之，有了它，我们写含代码的文档就方便多了。
...
2. 直接下载并安装我提供的 [**3.8.2-amd64-webinstall**](https://wiki-media-1253965369.cos.ap-guangzhou.myqcloud.com/doc/python-3.8.2-amd64-webinstall.exe) 版本
...
本篇文章讲解了 Jupyter Notebook 在 VS Code 上的配置和基本操作。更多 VS Code 的骚操作，请期待下一篇文章。
