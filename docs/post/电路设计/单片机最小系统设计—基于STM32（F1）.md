...
为了稳定，我们在设计的时候一般外接晶振作为时钟源。**一般选取 8MHz 晶振作为 HSE**，便于倍频（一般倍频到 72MHz）；**选取 32.768kHz 晶振作为 LSE**，RTC 使用便于分频。
...
**一般将 BOOT0 引脚下拉**（串接 10K 电阻再接地），**BOOT1 悬空** 即可。
